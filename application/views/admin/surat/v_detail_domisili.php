			...
			<div class="content table-responsive table-full-width">
				<table class="table table-hover table-striped table-borderless">
					...
					<tbody>
						...
						<tr>
							<th>Akta Pendirian UKM</th>
							<th>:</th>
							<td><a href="<?=base_url($detail->akta_usaha_file)?>" target="_blank">Lihat</a></td>
						</tr>
						<tr>
						...
						<tr>
							<th>Surat Perjanjian Sewa</th>
							<th>:</th>
							<td><a href="<?=base_url($detail->perjanjian_file)?>" target="_blank">Lihat</a></td>
						</tr>
						<tr>
							<th>Surat Kepemilikan Tanah</th>
							<th>:</th>
							<td><a href="<?=base_url($detail->kepemilikan_file)?>" target="_blank">Lihat</a></td>
						</tr>
					</tbody>
				</table>
