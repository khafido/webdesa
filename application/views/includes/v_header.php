    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <?php if (isset($_SESSION['nik'])): ?>
            <?php $foto = ($_SESSION['foto']!="")?$_SESSION['foto']:'default_profil.jpg'; ?>
            <li class="menu-has-children"><a href="" style="text-decoration:none;"><img class="" style="width:30px; height:30px; border-radius:100%;" src="<?=base_url('assets/img/warga/foto/'.$foto)?>" alt="">&ensp; <?=$_SESSION['nama']?> </a>
              <ul>
